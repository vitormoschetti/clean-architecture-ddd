...
public class CustomerEventDispatcher implements IEventDispatcher<IRecord> {

    private final Map<String, List<IEventHandler<IRecord>>> eventHandlers;
    ...
    @Override
    public void notify(final IEvent<IRecord> event) {
    ...
    @Override
    public void register(final String eventName, final IEventHandler<IRecord> handler) {
        if (!this.eventHandlers.containsKey(eventName)) {
            final var handlers = new ArrayList<IEventHandler<IRecord>>();
    ...
    @Override
    public void unregister(final String eventName, final IEventHandler<IRecord> handler) {
        if (this.eventHandlers.containsKey(eventName)) {
    ...
    @Override
    public List<IEventHandler<IRecord>> getEventHandlers(final String eventName) {
        if (this.eventHandlers.containsKey(eventName))
